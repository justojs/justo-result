...
CompositeTaskResult = function (_Result) {_inherits(CompositeTaskResult, _Result);
  ...
  function CompositeTaskResult(parent, title, task, state) {_classCallCheck(this, CompositeTaskResult);var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CompositeTaskResult).call(this, 
    ...
    state) {
      ...
      return this.results.getNumberOf(state);} }, { key: "state", get: function get() {if (this._state) return this._state;else return this.results.state;} }, { key: "error", get: function get() {return this.results.error;} }, { key: "time", get: function get() {return this.results.time;} }, { key: "count", get: function get() 
