...
CompositeTaskResult = (function (_Result) {_inherits(CompositeTaskResult, _Result);
  ...
  function CompositeTaskResult(parent, title, task) {_classCallCheck(this, CompositeTaskResult);
    ...
    function getNumberOf(state) {
      return this.results.getNumberOf(state);} }, { key: "state", get: function get() {return this.results.state;} }, { key: "error", get: function get() {return this.results.error;} }, { key: "time", get: function get() {return this.results.time;} }, { key: "count", get: 
